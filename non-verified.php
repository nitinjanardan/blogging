<html>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12" "well">
					<center><h2> All Non-Verified User</h2> </center>
					
									
											<input class= "btn btn-success" type="submit" name="verify" value="Verify"  >									
											<input class="btn btn-warning" type="submit" name="blocked" value="Block"  >
											<input class="btn btn-danger"type="submit" name="deleted1" value="Delete"  >
	...
	$sel="SELECT * FROM user_detail WHERE  verified='no'";
