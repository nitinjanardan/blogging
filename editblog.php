	...
	//<![CDATA[
		...
		<body>
			<?php
				...
				{	
				$blogid=$_GET['be'];
				$sel="SELECT * FROM post where blog_id=$blogid";
			...
			<div class="container">
				<div class="row">
					...
					<div class="well">
						<fieldset>
							<form action="database.php?ebid=<?php echo $blogid?>" method="POST" enctype="multipart/form-data">
								<div class="col-sm-12">
								...
								<div class="col-sm-12">
									<div class="form-group">
										<input type="submit" name="editing" class="form-group" value="Done" style="height:30px; width:50px;color:white; background-color:black;">
									</div>
								</div>
							</form>
						</fieldset>
